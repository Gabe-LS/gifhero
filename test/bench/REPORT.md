...
|--------|------|-----------------|
| **quality** | Maximum VMAF, never >5% larger than gifski | Lower staleThreshold (base 4), full 256-color palettes, no per-frame threshold boost, no denoiser |
| **balanced** (default) | Maximum compression | Higher staleThreshold (base 5), adaptive maxColors (192 at ≥20K), per-frame threshold boost, noise-aware temporal denoiser |
...
| Resolution | VMAF wins | Size wins | Avg VMAF Δ | Total size Δ |
|-----------|-----------|-----------|------------|-------------|
| **480p** | **7/25** | **24/25** | **+0.0** | **-18%** (52.9 vs 64.4 MB) |
| **360p** | **7/25** | **24/25** | **+0.1** | **-19%** (31.1 vs 38.1 MB) |
| **240p** | **14/25** | **25/25** | **+1.0** | **-19%** (14.9 vs 18.3 MB) |
| **160p** | **17/25** | **25/25** | **+1.7** | **-19%** (7.5 vs 9.2 MB) |
...
|-----------|---------|----------|--------|
| 480p | 13,369 (+6%) | 13,414 (+7%) | 12,570 |
| 360p | 13,535 (+7%) | 13,571 (+8%) | 12,613 |
| 240p | 13,815 (+9%) | 13,866 (+9%) | 12,704 |
| 160p | 14,215 (+10%) | 14,271 (+11%) | 12,900 |
...
| balanced | 480p | 24 | 1 | 0 | 0 | -22% |
| balanced | 360p | 24 | 1 | 0 | 0 | -25% |
| balanced | 240p | 25 | 0 | 0 | 0 | -25% |
| balanced | 160p | 25 | 0 | 0 | 0 | -21% |
...
| bbb-clip-07 | 2,067KB / **95.8** | **1,986KB** / 94.8 | 2,661KB / 90.5 |
| bbb-clip-08 | 6,766KB / 98.4 | **6,572KB** / 98.3 | **6,514KB** / 98.4 |
| bbb-clip-09 | 1,322KB / **95.3** | **1,302KB** / 95.1 | 1,730KB / 95.7 |
| bbb-clip-10 | 3,481KB / **99.9** | **3,431KB** / 99.9 | 4,451KB / **100.0** |
| big-buck-bunny | 2,292KB / **92.6** | **2,194KB** / 92.0 | 3,172KB / 91.9 |
| black-and-white | **10,999KB** / **99.9** | 11,021KB / 99.9 | 12,367KB / 99.9 |
...
| fast-action | 3,056KB / **98.7** | **3,057KB** / **98.8** | 3,282KB / 96.4 |
| jellyfish | 2,678KB / **96.4** | **2,552KB** / 95.9 | 2,939KB / **97.3** |
...
| shapes | 361KB / **96.6** | **327KB** / 96.1 | 398KB / 94.0 |
| sintel | 1,305KB / **98.3** | **1,163KB** / 97.5 | 1,457KB / 97.3 |
| skin-tones | 164KB / **97.2** | **129KB** / 97.0 | 180KB / 97.1 |
| talking-head | 1,255KB / **96.0** | **1,080KB** / 95.2 | 1,223KB / 95.0 |
...
| bbb-clip-07 | 1,245KB / **95.0** | **1,186KB** / 93.4 | 1,602KB / 88.4 |
| bbb-clip-08 | 3,932KB / **97.7** | **3,818KB** / 97.7 | **3,802KB** / 97.1 |
| bbb-clip-09 | 806KB / **94.7** | **705KB** / 93.1 | 1,039KB / 94.8 |
| bbb-clip-10 | 2,117KB / 99.5 | **2,060KB** / **99.7** | 2,806KB / **99.9** |
| big-buck-bunny | 1,299KB / **90.6** | **1,133KB** / 89.2 | 1,729KB / 89.5 |
| black-and-white | **6,452KB** / **99.9** | 6,477KB / 99.9 | 7,106KB / 99.8 |
...
| jellyfish | 1,632KB / **95.3** | **1,549KB** / 94.9 | 1,770KB / 95.5 |
| pixel-art | 271KB / **99.7** | **269KB** / 99.6 | 323KB / 99.6 |
| screen-recording | 377KB / 99.2 | **358KB** / 98.9 | 478KB / **99.3** |
| screencast | 13KB / **93.7** | **12KB** / 93.3 | 44KB / 93.4 |
| shapes | 248KB / **93.1** | **235KB** / 92.6 | 313KB / **94.2** |
| sintel | 777KB / **98.6** | **698KB** / 97.7 | 950KB / 97.2 |
| skin-tones | 102KB / 96.7 | **87KB** / 96.5 | 161KB / **96.9** |
| talking-head | 766KB / **94.9** | **652KB** / 93.9 | 755KB / 93.5 |
| two-frame | 0.4KB / **98.7** | 0.4KB / 98.7 | 0.5KB / 98.7 |
...
| bbb-clip-07 | 664KB / **94.2** | **652KB** / 92.2 | 828KB / 85.7 |
| bbb-clip-08 | 1,922KB / **96.0** | **1,830KB** / 95.8 | 1,909KB / 93.3 |
| bbb-clip-09 | 441KB / **92.4** | **377KB** / 90.5 | 519KB / 92.0 |
| bbb-clip-10 | 950KB / 94.7 | **925KB** / **94.9** | 1,322KB / **95.9** |
| big-buck-bunny | 701KB / **88.1** | **576KB** / 86.4 | 786KB / 84.7 |
| black-and-white | **2,782KB** / **97.1** | 2,765KB / 96.8 | 3,116KB / 92.5 |
...
| fast-action | **875KB** / **94.4** | 877KB / 94.3 | 930KB / 86.8 |
| jellyfish | 812KB / **92.4** | **776KB** / 92.0 | 897KB / 91.7 |
| pixel-art | 170KB / **100.0** | **167KB** / 100.0 | 181KB / 100.0 |
| screen-recording | **185KB** / 97.4 | 190KB / 97.2 | 262KB / **97.5** |
| screencast | 8KB / 90.3 | **8KB** / **91.2** | 42KB / 89.4 |
| shapes | 146KB / **93.1** | **141KB** / 92.3 | 197KB / 91.6 |
| sintel | 394KB / **99.0** | **385KB** / 98.7 | 513KB / 96.9 |
| skin-tones | 60KB / **95.7** | **50KB** / 95.5 | 107KB / 96.1 |
| talking-head | 389KB / **92.7** | **340KB** / 91.4 | 395KB / 90.8 |
| two-frame | 0.4KB / **98.7** | 0.4KB / 98.7 | 0.5KB / 98.7 |
...
| bbb-clip-07 | 358KB / **91.4** | **338KB** / 88.9 | 427KB / 81.4 |
| bbb-clip-08 | 945KB / **92.9** | **943KB** / 92.6 | 974KB / 87.3 |
| bbb-clip-09 | 236KB / **88.9** | **213KB** / 87.3 | 273KB / 88.7 |
| bbb-clip-10 | 456KB / **87.5** | **430KB** / 86.9 | 646KB / 86.2 |
| big-buck-bunny | 332KB / **84.8** | **277KB** / 82.9 | 333KB / 79.5 |
| black-and-white | **1,218KB** / **91.2** | 1,208KB / 90.7 | 1,349KB / 83.7 |
...
| fast-action | 437KB / **90.8** | **414KB** / 89.2 | 448KB / 80.3 |
| jellyfish | 409KB / **87.7** | **407KB** / 87.6 | 449KB / 85.9 |
| pixel-art | 101KB / **100.0** | 101KB / 100.0 | 112KB / 100.0 |
| screen-recording | 100KB / **94.3** | **99KB** / 93.6 | 151KB / 93.3 |
| screencast | 6KB / **88.3** | 6KB / 86.3 | 25KB / **87.9** |
| shapes | 88KB / **91.4** | **86KB** / 90.7 | 128KB / 90.7 |
| sintel | 207KB / **100.0** | **199KB** / 100.0 | 275KB / 98.5 |
| skin-tones | 34KB / **95.4** | **29KB** / 95.2 | 77KB / **97.0** |
| talking-head | 206KB / **91.2** | **191KB** / 90.4 | 208KB / 87.9 |
| two-frame | 0.4KB / **98.7** | 0.4KB / 98.7 | 0.5KB / 98.7 |
...
### Temporal Denoiser (balanced preset only)

3-frame temporal median filter. For each pixel, if all 3 consecutive values differ by ≤3 per channel, replaces with the median (an actual observed value, never interpolated).

**Noise-aware gate** — only activates when both conditions are met:
1. Sub-perceptual changes (1-2 per channel) affect >5% of pixels — confirms sensor/compression noise
2. Motion (>5 per channel changes) affects >2% of pixels — ensures content isn't near-static

This correctly skips synthetic content (shapes: 0.4% sub-perceptual), near-static clips (skin-tones: 0.5% motion), and rendered content (pixel-art: 0%).
