...
module.exports = {
  ...
  outputName: 'smart-fwd2',
  workers: 6,
  variants: [
    { label: 'baseline' },
    { label: 'tex-only', patch: makeTexOnly() },
    { label: 'dfwd3-g30', patch: makeDirectionFwd(3, 30) },
    { label: 'dfwd3-g40', patch: makeDirectionFwd(3, 40) },
    { label: 'dfwd4-g30', patch: makeDirectionFwd(4, 30) },
    { label: 'dfwd4-g40', patch: makeDirectionFwd(4, 40) },
  ],
};
