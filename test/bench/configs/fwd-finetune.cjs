...
function makePatch(fwdThreshold) {
  return (src) => {
...
module.exports = {
  ...
  outputName: 'fwd-finetune',
  workers: 6,
  variants: [
    { label: 'baseline' },
    { label: 'tex', patch: makeTexOnly() },
    { label: 'tex-fwd2', patch: makePatch(2) },
    { label: 'tex-fwd3', patch: makePatch(3) },
    { label: 'tex-fwd4', patch: makePatch(4) },
  ],
};
